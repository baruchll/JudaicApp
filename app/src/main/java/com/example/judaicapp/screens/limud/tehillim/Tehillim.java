...
public class Tehillim extends Fragment {
    ...
    private void storageInit2() {
        pdfUrl = new HashMap<>();
        //add tehillim pdf inside hashmap with day of month or week as key and link as value
        pdfView = requireView().findViewById(R.id.pdfview);
        Integer dayOfYear = Calendar.DAY_OF_MONTH; // or week
